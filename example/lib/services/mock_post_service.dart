...
class MockPostService {
  ...
  static final List<Post> _mockPosts = [
    const Post(
      ...
      body:
          'This is a demonstration of the API Request package with clean architecture and best practices. This post is generated locally to show the UI and functionality.',
    ),
    const Post(
      id: 2,
      userId: 1,
      ...
      body:
          'This example showcases how to structure your Flutter app with proper separation of concerns, service layers, and error handling using the API Request package.',
    ),
    const Post(
      id: 3,
      userId: 2,
      ...
      body:
          'The API Request package provides excellent error handling capabilities with Either types from fpdart, allowing for functional programming patterns in Flutter.',
    ),
    const Post(
      id: 4,
      userId: 2,
      ...
      body:
          'Built-in performance monitoring helps you track API request performance and optimize your application\'s network operations.',
    ),
    const Post(
      id: 5,
      userId: 3,
      ...
      body:
          'This example uses Material 3 design principles with clean, modern UI components and proper state management.',
    ),
  ];
